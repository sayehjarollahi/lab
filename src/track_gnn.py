...
from src.lib.tracker.multitracker import GNNTracker
...
import src.lib.datasets.dataset.gsdt_dataset as datasets
from src.lib.datasets.dataset.gsdt_dataset import JointDatasetGNN, letterbox
...
if __name__ == '__main__':
    ...
    if not opt.eval_from_file_only:
        ...
        if opt.visualize_gt:
            from src.lib.tracking_utils.utils import visualize_fp_fns_seq
            visualize_fp_fns_seq(opt.eval_result_dir, data_root, seqs, return_fn=False, return_fp=False)

        if opt.visualize_compare:
            from src.lib.tracking_utils.utils import visualize_comparison
